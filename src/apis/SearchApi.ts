...
export class SearchApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for searchModelsApiSearchGet without sending the request
     */
    async searchModelsApiSearchGetRequestOpts(requestParameters: SearchModelsApiSearchGetRequest): Promise<runtime.RequestOpts> {
     ...
     * Search Models
     */
    async searchModelsApiSearchGetRaw(requestParameters: SearchModelsApiSearchGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{ [key: string]: any; }>> {
        const requestOptions = await this.searchModelsApiSearchGetRequestOpts(requestParameters);
     ...
     * Search Models
     */
    async searchModelsApiSearchGet(requestParameters: SearchModelsApiSearchGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<{ [key: string]: any; }> {
